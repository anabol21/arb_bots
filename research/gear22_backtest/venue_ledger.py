...
def write_balance_5m_html(
    ...
    *,
    ...
    _write_equity_monitor_html(
        ...
        title=title or "Gear 2.2 — equity каждые 5 минут (наблюдение)",
        heading=heading or "Equity Bybit / OKX каждые 5 минут — наблюдение, не прибыль",
        warn=warn
        or (
...
<style>
  ...
  ul {{ font-size: 0.9rem; }}
  table {{ border-collapse: collapse; width: 100%; font-size: 0.92rem; margin-top: 12px; }}
